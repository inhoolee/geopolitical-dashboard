...
| 3 | **ACLED (2017–present)** | UCDP ends 2024-12-31; zero incident rows exist for 2025–2026. Register at acleddata.com, set `ACLED_USERNAME` + `ACLED_PASSWORD`, then run `uv run python scripts/run_pipeline.py --sources acled`. |
...
| ACLED | 0 | ⚠️ Needs `ACLED_USERNAME` + `ACLED_PASSWORD` |
