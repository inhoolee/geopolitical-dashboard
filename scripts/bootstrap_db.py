...
SOURCE_SYSTEM_SEED = [
    ("ACLED", "Armed Conflict Location and Event Data Project",
     "https://acleddata.com", "Download", "2017-01-20", None,
     "Loaded from local regional aggregate CSV snapshots in data/raw/acled"),
    ("ACLED_MANUAL", "ACLED manual KPI backfill",
     "https://acleddata.com/aggregated-data-files/", "Manual", "2026-02-16", "2026-02-16",
     "Manual weekly aggregates for Jan-Feb 2026 KPI backfill; event counts sourced from ACLED country-month summaries and fatalities estimated when monthly fatality totals were unavailable"),
